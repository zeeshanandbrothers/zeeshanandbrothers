    ...
    <div className="p-6">
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-3 w-full sm:w-auto">
          ...
          <select
            className="border px-3 py-2 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-64"
            value={category}
                    ...
                    <tr key={p._id} className="text-left border hover:bg-gray-50">
                      ...
                      {category === "inverter" && (
                        <>
                          ...
                          <td className="p-2 border">{p.modelNo}</td>
                        </>
                      )}
            ...
            >
              ...
              {editProduct.category === "inverter" && (
                <>
                  ...
                  <label className="block font-semibold">Model No</label>
                  <input
                    type="text"
                    name="modelNo"
                    defaultValue={editProduct.modelNo || ""}
                    className="border p-2 w-full"
                    disabled={isUpdating}
                    onChange={handleChange}
                  />
