  ...
  return (
    <footer className="py-10 px-4 sm:px-6 lg:px-8 border-t border-border/60 bg-background/70  shadow-[0_-2px_8px_-2px_rgba(0,0,0,0.1)] font-inter relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
        <div className="mb-6 flex sm:flex-row flex-col items-center gap-3 justify-center">
          <img
            src="/images/logo.png"
            alt="Zeeshan & Brothers logo"
            className="h-12 w-auto rounded-sm ring-1 ring-border transition-transform duration-300 hover:scale-[1.03]"
          />
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-4">
          &copy; {new Date().getFullYear()} zeeshan&brothers. All rights
          reserved.
        </p>
      </div>
    </footer>
